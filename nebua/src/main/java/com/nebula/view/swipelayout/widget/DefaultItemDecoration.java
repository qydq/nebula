 ...
 */
package com.nebula.view.swipelayout.widget;
...
import com.nebula.view.swipelayout.SwipeMenuRecyclerView;
...
public class DefaultItemDecoration extends RecyclerView.ItemDecoration {
    ...
    /*todo add more control dividerHeight 晴雨*/
    public DefaultItemDecoration(@ColorInt int color,int dividerHeight) {
        this(color, 2, dividerHeight, -1);
    }
