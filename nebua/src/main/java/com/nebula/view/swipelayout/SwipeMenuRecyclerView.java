 ...
 */
package com.nebula.view.swipelayout;
...
import com.nebula.view.swipelayout.touch.DefaultItemTouchHelper;
import com.nebula.view.swipelayout.touch.OnItemMoveListener;
import com.nebula.view.swipelayout.touch.OnItemMovementListener;
import com.nebula.view.swipelayout.touch.OnItemStateChangedListener;
import com.nebula.view.swipelayout.widget.DefaultLoadMoreView;
...
public class SwipeMenuRecyclerView extends RecyclerView {
    ...
    public boolean onInterceptTouchEvent(MotionEvent e) {
        ...
        Log.i("SwipeMenuRecyclerView", "--qydq->viewParent"+viewParent.toString());
        ViewParent outRlParent = null;
        if (viewParent != null) {
            ViewParent rlParent = viewParent.getParent();
            Log.i("SwipeMenuRecyclerView", "--qydq->rlParent"+rlParent.toString());
            if (rlParent != null) {
                outRlParent = rlParent.getParent();
                Log.i("SwipeMenuRecyclerView", "--qydq->outRlParent"+outRlParent.toString());
            }
        }
